  ...
  return (
    <TouchableOpacity onPress={onPress} className='flex flex-col items-start w-60 h-80 relative'>
      ...
      <View className='flex flex-col items-start absolute bottom-5 inset-x-5'>
        <Text className='text-xl font-rubik-extrabold text-white w-full' numberOfLines={1}>Modern Apartment</Text>
        <Text className='text-base text-white font-rubik' numberOfLines={1}>88-1011, Shikadanicho Shida</Text>
  ...
  return (
    ...
    >
      ...
      <View className='flex flex-col mt-2'>
        ...
        <Text className='text-xs text-black-100 font-rubik' numberOfLines={1}>88-1011, Shikadanicho Shida</Text>
